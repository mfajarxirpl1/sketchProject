...
# siapkan 1 gambar di folder yng sama
...
img = "Screenshot (345).png" #nama file input

def rgb2gray(rgb):
    return np.dot(rgb[...,:3],[0.2989,0.5870,0.1140])
    # formula untuk convert img -> grayscale // pakai kode

def dodge(front,back):
    final_sketch = front*225/(255-back)
    #kalau gambarnya lebih besar dari 255 () maka akan diconvertjadi 255
